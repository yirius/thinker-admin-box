...
public class LogAopAdvice {
    ...
    public static final String POINTCUT_SIGN =
            "@within(com.thinker.framework.framework.aspect.logs.ThinkerLogAspect) || " +
                    "@annotation(com.thinker.framework.framework.aspect.logs.ThinkerLogAspect)";
    ...
    private void writeWarnLog(JoinPoint joinPoint, String type, String msg) {
        ...
        ThinkerLogAspect thinkerLogAspect = signature.getMethod().getAnnotation(ThinkerLogAspect.class);
